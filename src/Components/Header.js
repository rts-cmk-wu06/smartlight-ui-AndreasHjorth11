...
const Header = () => {
    return ( 
        <div className="text-white text-4xl font-bold h-40 flex content-center justify-between overflow-hidden relative">
            ...
            <div className='h-40 bg-white/5 rounded-full w-40 absolute -mt-20 -ml-10 z-0'></div>
            <div className='h-40 bg-white/5 rounded-full w-40 absolute mt-36 ml-8 z-0'></div>
            <div className=''>
